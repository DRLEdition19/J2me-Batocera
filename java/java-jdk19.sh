...
url=https://github.com/DRLEdition19/Profork-2/raw/main/.dep
...
wget -q -O $pro/$appname/extra/icon.png https://github.com/DRLEdition19/Profork-2/raw/main/$appname/extra/icon.png; chmod a+x $dep/tput; cd ~/
# --------------------------------------------------------------------
# // end of dependencies 
#
# --------------------------------------------------------------------
...
url=https://github.com/DRLEdition19/Profork-2/raw/main/
