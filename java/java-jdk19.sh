...
url=https://github.com/DRLEdition19/J2me-Batocera/raw/main/.dep
...
wget -q -O $pro/$appname/extra/icon.png https://github.com/DRLEdition19/J2me-Batocera/raw/main/$appname/extra/icon.png; chmod a+x $dep/tput; cd ~/
# --------------------------------------------------------------------
# // end of dependencies 
#
# --------------------------------------------------------------------
...
url=https://github.com/DRLEdition19/J2me-Batocera/raw/main/
